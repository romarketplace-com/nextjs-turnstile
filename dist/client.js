...
function useCallbackRefs(callbacks) {
  const refsObject = (0, import_react.useRef)(
    Object.keys(callbacks).reduce(
      (acc, key) => {
        acc[key] = (0, import_react.useRef)(callbacks[key]);
        return acc;
      },
      {}
    )
...
var Turnstile = (0, import_react2.forwardRef)(function Turnstile2({
  ...
  const widgetIdRef = (0, import_react2.useRef)(void 0);
  ...
  const getTurnstile2 = (0, import_react2.useCallback)(() => {
